package com.qhao.mathutil.main;

import com.qhao.mathutil.core.MathUtility;
...
public class Main {
    ...
    public static void testFactorialGivenWrongArgumentMinus1ThrowsException() {
        ...
        //vậy giờ nếu đưa -1 mà ném ngoại lệ -> HÀM OKE
    }


    /*hàm kiểm thử code chính của mình, hàm này dân dev dùng để test code
     chính,code chính là hàm getFactorial() bên .core */
    //Tên hàm kiểm thử mang luôn ý nghĩa của test code
    //ví dụ dưới này: cho tham số tử tế RightArg 0 thì hàm pha chạy ngon run well
